...
3.  Run the `deploy` script (e.g. `npm run deploy`) to create the `gh-pages` branch
4.  On GitHub, go to **Settings** > **Pages** > **Source**, and choose **GitHub Actions** as the source.
